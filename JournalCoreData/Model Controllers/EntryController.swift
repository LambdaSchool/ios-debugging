...
class EntryController {
    ...
    private func put(entry: Entry, completion: @escaping ((Error?) -> Void) = { _ in }) {
        ...
        let requestURL =
            // appending path extension for the json
            baseURL.appendingPathComponent(identifier).appendingPathExtension("json")
